        ...
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link
                href="#cho-muon-do"
                onClick={() => setActiveLink("cho-muon-do")}
                className={activeLink === "cho-muon-do" ? "active" : ""}
              >
                Cho mượn đồ
              </Nav.Link>
              <Nav.Link
                href="#muon-do-choi"
                onClick={() => setActiveLink("muon-do-choi")}
                className={activeLink === "muon-do-choi" ? "active" : ""}
              >
                Mượn đồ chơi
              </Nav.Link>
              <Nav.Link
            ...
            <Nav className="ms-auto align-items-center">
              ...
              {!isLoggedIn ? (
                <Nav.Link href="#login" onClick={() => setActiveLink("login")}>
                  Đăng nhập
                </Nav.Link>
              ) : (
                <Nav.Link
